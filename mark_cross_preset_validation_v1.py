...
<title>Cross-Preset Bearing Validation</title>
...
<header>
  <h2>Same-target Cross-Preset Validation</h2>
  <div id="status"></div>
</header>
...
<div class="help">
<b>นี่คือ Validation ไม่ใช่ Calibration</b><br><br>
